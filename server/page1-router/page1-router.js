...
const serverBundleFilePath = path.resolve(rootdir, env + '/js/server-js/page1.server.js')
...
const clientBundleFilePath = path.resolve(rootdir, env + '/js/client-js/page1.client.js');
const clientBundleFileUrl = '/js/client-js/page1.client.js';
const serverBundleStylePath = '/css/page1.css';
    ...
    render: function (res) {
        bundleRenderer.renderToString((err, html) => {
            if (err) {
                ...
                res.send(template(html, clientBundleFileUrl, serverBundleStylePath, 'html1title').html);
            }
        });
    },
